...
/**
 * Builds the XHTML content for the Amazon Search pop up window.
 *
 * @package MemexPlex
 * @subpackage Presentation
 * @author The Smoking GNU
 * @see HtmlContent
 * @see HtmlContentInterface
 */
class HtmlContentAmazonSearch extends HtmlContent
implements HtmlContentInterface
{
    ...
    public function setSource()
    {
        ...
        try
        {
            ...
            $pageObjects = new PageObjectsAmazonSearch;
...
//            echo "</pre>";
            ...
            $currentRow = 1;
            //LOOP THROUGH ROWS
            foreach($pageObjectsXml->ItemSearchResponse->Items->Item as $rowdata)
            {
                $listSource .= 
                    "<div class=\"modalreferencedivlistitem\">";
                //LOOP THOUGH FORM ELEMENTS
                foreach($formArray->amazonlist->formfield as $formfield)
                {
