...
class DB_API {
	...
	function parse_query( $query = null ) {
		...
		if ( !in_array( $parts['format'], array( 'html', 'xml', 'json', 'count' ) ) ) {
			$parts['format'] = null;
		}
...
/**
	 * Output row count
	 */
	function render_count( $data, $query ) {
